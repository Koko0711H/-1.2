      ...
      <div className={"anim-block " + ac} key={stage.id}>
        ...
        {isA && (
          <div className="allinone-top-right text-block-animate">
            ...
            <img className="module-img" src="/product-assets/open-frame-500/images/allinone.jpg" alt="ALL-IN-ONE" />
          </div>
        )}
        {isE && (
          <div>
            <img className="engine-img" src="/product-assets/open-frame-500/images/allinone.jpg" alt="动力系统" />
        ...
        {isAf && (
          <div className="airflow-top-right text-block-animate">
            <img className="module-img" src="/product-assets/open-frame-500/images/airflow.png" alt="气流设计" />
            <p className="airflow-desc-text">{t("airflowDesc")}</p>
          </div>
        )}
        {isC && (
          <div className="chassis-right text-block-animate">
            <img className="module-img chassis-img" src="/product-assets/open-frame-500/images/chassis.png" alt="减震设计" />
      ...
      <div className="scene">
        <Canvas
          ...
          <Suspense fallback={null}>
            <ModelGroup url="/product-assets/open-frame-500/generator.glb" progress={progress} />
          </Suspense>
          <Particles />
