      ...
      <div className={"anim-block " + ac} key={stage.id}>
        ...
        {isA && (
          <div className="allinone-top-right text-block-animate">
            ...
            <img className="module-img" src="/product-assets/silent/images/allinone.jpg" alt="ALL-IN-ONE" />
          </div>
        )}
        {isE && (
          <div>
            <img className="engine-img" src="/product-assets/silent/images/engine-new.jpg" alt="动力系统" />
        ...
        {isAf && (
          <div className="airflow-top-right text-block-animate">
            <img className="module-img" src="/product-assets/silent/images/airflow-new.jpg" alt="气流设计" />
            <p className="airflow-desc-text">{t("airflowDesc")}</p>
          </div>
        )}
        {isC && (
          <div className="chassis-right text-block-animate">
            <img className="module-img chassis-img" src="/product-assets/silent/images/chassis-new.jpg" alt="减震设计" />
