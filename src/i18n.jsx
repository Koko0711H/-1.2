...
const translations = {
  ...
  reviewEyebrow: { en: 'CUSTOMER VOICE / GOOGLE', zh: '客户之声 / GOOGLE' },
  reviewTitle: { en: 'Five-Star Trust, Built in Real Use.', zh: '客户满意，是可靠交付的直接证明。' },
  reviewSub: { en: 'Selected customer feedback from Google across construction, farming, home backup, field operations and medical facilities.', zh: '精选来自谷歌的客户使用反馈，覆盖工程、农场、家庭备用、现场作业与医疗设施等真实场景。' },
  reviewFiveStars: { en: 'Five out of five stars', zh: '五星好评' },
  reviewVerified: { en: 'Google · Verified Review', zh: '谷歌 · 已验证评价' },
