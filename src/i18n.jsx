...
const translations = {
  ...
  // ===== About =====
  aboutTitle: { en: 'About FLYDEER POWER', zh: '关于深柴能源' },
  aboutSub: { en: 'A Trusted Generator Set Manufacturer', zh: '值得信赖的发电机组制造商' },
  aboutH3: { en: '20 Years of Excellence', zh: '二十年专注，铸就行业品牌' },
  aboutP1: { en: 'FLYDEER POWER is a comprehensive enterprise integrating R&D, production, sales and service of diesel generator sets. The company has a modern production base with an annual capacity of over 5,000 units.', zh: '深柴能源是一家集柴油发电机组研发、生产、销售和服务于一体的综合性企业。公司拥有现代化生产基地，年产能超过5000台套。' },
  aboutP2: { en: 'Leveraging the strength of state-owned enterprises and combining it with market-driven innovation, FLYDEER POWER has grown into a leading manufacturer of diesel generator sets.', zh: '依托国企实力，结合市场化创新机制，深柴能源已发展成为国内领先的柴油发电机组制造商。' },
  aboutPageBtn: { en: 'About FLYDEER POWER', zh: '关于深柴能源' },
  aboutImgAlt: { en: 'FLYDEER POWER Headquarters', zh: '深柴能源总部大楼' },
  ...
  reviewEyebrow: { en: 'CUSTOMER VOICE / AMAZON', zh: '客户之声 / AMAZON' },
  reviewTitle: { en: 'Five-Star Trust, Built in Real Use.', zh: '客户满意，是可靠交付的直接证明。' },
  reviewSub: { en: 'Selected feedback from Amazon customers across construction, farming, home backup, field operations and medical facilities.', zh: '精选来自亚马逊客户的使用反馈，覆盖工程、农场、家庭备用、现场作业与医疗设施等真实场景。' },
  reviewFiveStars: { en: 'Five out of five stars', zh: '五星好评' },
  reviewVerified: { en: 'Amazon · Verified Purchase', zh: '亚马逊 · 已验证购买' },
  review1Role: { en: 'Construction Site Manager', zh: '建筑项目主管' },
  review1Title: { en: 'Reliable Power for a Remote Project', zh: '远程工地的可靠主力' },
  review1Quote: { en: 'It powered our tools and site trailers around the clock for three months on a remote project. No breakdowns, and the supply stayed steady throughout.', zh: '在偏远项目连续三个月为工具和现场拖车供电，全天运行没有出现故障，整个项目期间供电始终稳定。' },
  review2Role: { en: 'Family Farm Owner', zh: '家庭农场经营者' },
  review2Title: { en: 'The Farm Keeps Running', zh: '停电时，农场依然正常运转' },
  review2Quote: { en: 'It keeps our grain-drying equipment and livestock barns running during rural outages. Fuel-efficient, easy to start and dependable for daily farm work.', zh: '乡村停电时，粮食烘干设备和畜舍仍能正常运行。省油、启动方便，日常农场作业用起来很可靠。' },
  review3Role: { en: 'Home Backup User', zh: '家庭备用电源用户' },
  review3Title: { en: '18 Hours Through a Blackout', zh: '停电期间连续运行 18 小时' },
  review3Quote: { en: 'It ran continuously for 18 hours during a blackout with no issues. Good value and dependable backup power for the whole house.', zh: '停电时连续运行了 18 小时，没有出现任何问题。性价比很好，是值得信赖的全屋备用电源。' },
  review4Role: { en: 'Rural Property Manager', zh: '乡村物业管理者' },
  review4Title: { en: 'Efficient Unit, Responsive Support', zh: '省油易用，服务响应及时' },
  review4Quote: { en: 'The unit is light on fuel and starts easily. The support team responded clearly and quickly whenever we needed help.', zh: '机组燃油效率高，启动也很方便。需要帮助时，服务团队的回复清晰而及时。' },
  review5Role: { en: 'Field Operations Supervisor', zh: '现场运营主管' },
  review5Title: { en: 'Heavy-Duty Performance on Site', zh: '重载工况下表现可靠' },
  review5Quote: { en: 'It powered our tools, lighting and office trailers through a three-day site outage. Reliable performance under a demanding workload.', zh: '工地停电三天期间，它持续为工具、照明和办公拖车供电，在高负载工况下依然表现可靠。' },
  review6Role: { en: 'Small-Business Owner', zh: '小型企业经营者' },
  review6Title: { en: 'Quality Build, Smooth Handover', zh: '做工扎实，交付顺畅' },
  review6Quote: { en: 'Build quality is excellent, delivery was fast and setup was straightforward. The entire purchase and handover experience was smooth.', zh: '做工质量很好，到货速度快，安装也不复杂。整个购买和交付过程都很顺畅。' },
  review7Role: { en: 'Rural Hospital Facilities Manager', zh: '乡村医院设施负责人' },
  review7Title: { en: 'Critical Backup for Medical Care', zh: '医疗设施的关键备用电源' },
  review7Quote: { en: 'It started immediately when the grid failed and kept critical medical equipment and lighting online. Quiet, steady and exactly what our facility needed.', zh: '电网故障时机组立即启动，保障了关键医疗设备和照明持续运行。安静、稳定，正是我们设施需要的备用电源。' },
  review8Role: { en: 'Facilities Coordinator', zh: '设施协调负责人' },
  review8Title: { en: 'Dependable Through Severe Storms', zh: '暴风雨期间持续保障供电' },
  review8Quote: { en: 'During severe storms it kept barn lighting and water pumps working without interruption. Simple to operate and reassuringly reliable.', zh: '强风暴期间，畜舍照明和水泵始终没有中断。操作简单，稳定性让人安心。' },
  review9Role: { en: 'Coastal Homeowner', zh: '沿海地区家庭用户' },
  review9Title: { en: 'Three Days Through the Storm', zh: '风暴停电期间连续供电三天' },
  review9Quote: { en: 'During hurricane season it powered our entire house for three days without stopping. Surprisingly quiet for its output and completely dependable.', zh: '飓风季停电期间，它连续三天为整栋房屋供电。以这样的输出功率来说非常安静，运行也始终可靠。' },
  review10Role: { en: 'Agricultural Equipment Operator', zh: '农业设备运营者' },
  review10Title: { en: 'Starts Easily, Powers Every Farm Load', zh: '启动轻松，农场设备供电充足' },
  review10Quote: { en: 'It handles all of our farm equipment with ease and starts on the first attempt every time. It has been worth every penny.', zh: '农场里的各类设备都能轻松带动，每次都能顺利启动。这台机组的投入非常值得。' },
  review11Role: { en: 'Equipment Workshop Owner', zh: '设备维修车间经营者' },
  review11Title: { en: 'Excellent Support, Ready to Buy Again', zh: '服务出色，值得再次购买' },
  review11Quote: { en: 'Fuel-efficient, easy to move and the best generator I have owned. Customer support was excellent, and I would confidently buy again.', zh: '省油、移动方便，是我使用过表现最好的一台发电机。客户支持非常出色，我会放心再次购买。' },
  review12Role: { en: 'Construction Project Coordinator', zh: '建筑项目协调负责人' },
  review12Title: { en: 'All Tools and Site Offices Stayed Online', zh: '工具与现场办公持续在线' },
  review12Quote: { en: 'During a three-day power failure it kept our tools, lights and site offices running without interruption. A dependable choice for construction work.', zh: '工地停电三天期间，工具、照明和现场办公室始终保持运行。对于建筑施工来说，是很可靠的选择。' },
  ...
  footerCopyright: { en: '© 2026 FLYDEER POWER. All Rights Reserved.', zh: '© 2026 深柴能源 版权所有' },
