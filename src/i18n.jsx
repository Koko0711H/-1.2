...
const translations = {
  ...
  reviewExpand: { en: 'View Customer Reviews', zh: '查看客户评价' },
  reviewCollapse: { en: 'Hide Customer Reviews', zh: '收起客户评价' },
  reviewScoreLabel: { en: 'CUSTOMER RATING', zh: '客户评分' },
  reviewFiveStars: { en: 'Five out of five stars', zh: '五星好评' },
  reviewSummary: { en: '8 selected five-star customer reviews', zh: '8 条精选五星客户评价' },
  reviewSummarySub: { en: 'Every review shown here reflects generator performance in a practical operating scenario.', zh: '每一条评价，都来自发电机组在具体使用场景中的真实体验。' },
  reviewPrivacy: { en: 'To protect customer privacy, the names and portraits shown here have been anonymized while the meaning of each review is retained.', zh: '为保护客户隐私，页面中的姓名与头像均已匿名化处理，评价原意予以保留。' },
